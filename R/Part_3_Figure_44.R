...
ggsave("figures/Part_3_Figure_44.jpg", plot = scam_plots, height = 6, width = 10)

# copy of figure 44 in Supplement S3
ggsave("figures/Part_S3_Figure_S3-1.jpg", plot = scam_plots, height = 6, width = 10)